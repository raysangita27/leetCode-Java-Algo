...
stack [1,5], [2,1],[3,5]
maxStack [2,1] [1,5] [3,5]

*/

class MaxStack {
    TreeSet<int[]> stack;
    TreeSet<int[]> maxStack;
    int index;
    public MaxStack() {
    ...
    public void push(int x) {
        ...
        maxStack.add(new int[]{x, index});
        index++;
    }
    
    public int pop() {
        var item = stack.pollLast() ;
        maxStack.remove(new int[]{item[1], item[0]});
        return item[1] ;  
    }
    ...
    public int peekMax() {
        var item = maxStack.last() ;
         return item[0];      
    }
    
    public int popMax() {
        var item = maxStack.pollLast() ;  
